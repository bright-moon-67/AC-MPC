...
def convert(args: argparse.Namespace) -> dict[str, object]:
    ...
    if (observation_dim, action_dim) != (41, 18):
        raise ValueError(
            "ManiSoft Koopman conversion requires observation/action dimensions (41,18), "
    ...
    metadata: dict[str, object] = {
        ...
        "transition_semantics": {
            "source_state": "41D physical state s_t",
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Merge ManiSoft episode NPZ files and build canonical 59D-state/18D-delta "
